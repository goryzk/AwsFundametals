using Customers.DynamoDb.Api.Contracts.Requests;
using Customers.DynamoDb.Api.Mapping;
using Customers.DynamoDb.Api.Services;
using Microsoft.AspNetCore.Mvc;

namespace Customers.DynamoDb.Api.Controllers;
